        ...
        <div className="relative min-h-[100dvh] overflow-hidden bg-black text-white font-sans selection:bg-fuchsia-500 selection:text-white">
            ...
            >
                <div className="relative max-w-2xl mx-auto px-6 py-20 pb-40">
                    ...
                    <div ref={cardRef} className="relative rounded-[2rem] border border-white/10 bg-black/30 backdrop-blur-xl px-8 py-12 md:px-12 md:py-16 shadow-[0_0_60px_rgba(0,0,0,0.8)] transition-transform duration-75 ease-out will-change-transform group">
